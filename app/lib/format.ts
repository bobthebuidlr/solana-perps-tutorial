import { TOKEN_DECIMALS, USDC_DECIMALS } from "./constants";
 ...
 */
export function formatTokenQty(amount: bigint): string {
 ...
 */
export function formatPnl(amount: bigint): string {
 ...
 */
export function pnlColorClass(amount: bigint): string {
